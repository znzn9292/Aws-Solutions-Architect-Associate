...
## Aurora RDS
AWS Certified Solutions Architect - Associate (SAA-C03) 시험에 나올 만한 AWS Aurora RDS의 주요 내용을 정리해보겠습니다. Aurora는 Amazon의 고성능 관계형 데이터베이스 서비스로, MySQL 및 PostgreSQL 호환성, 고가용성, 자동 복구, 확장성 등 여러 가지 강력한 기능을 제공합니다.

## AWS Aurora RDS 주요 내용
